      ...
      {step === 1 ? (
        ...
        <Box component="form" onSubmit={onSubmit}>
          ...
          <TextField
            ...
            error={Boolean(requiredErrors.fullName)}
          ...
          <TextField
            ...
            error={Boolean(requiredErrors.email)}
            helperText={requiredErrors.email ?? " "}
            sx={{ mb: 1 }}
          />
          ...
          {vetMode && (
            <>
              ...
              <TextField
                ...
                error={Boolean(requiredErrors.clinicName)}
                helperText={requiredErrors.clinicName ?? " "}
                sx={{ mb: 1 }}
              />
              ...
              <TextField
                ...
                error={Boolean(requiredErrors.clinicAddress)}
                helperText={requiredErrors.clinicAddress ?? " "}
                sx={{ mb: 1 }}
              />
          ...
          <TextField
            ...
            error={Boolean(requiredErrors.phone)}
            helperText={requiredErrors.phone ?? " "}
            sx={{ mb: 1 }}
          />
          ...
          <TextField
            ...
            error={Boolean(requiredErrors.password)}
            helperText={requiredErrors.password ?? " "}
            sx={{ mb: 1.5 }}
          />
